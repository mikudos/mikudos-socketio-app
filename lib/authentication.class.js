...
class Authentication {
    constructor({ protocol = 'http', host = '127.0.0.1', port = '80', path = '/authentication', method, headers = {} } = {}, { tokenPath = 'accessToken', eventPath = 'authentication', authJoinCallback = async (socket, io) => { } } = {}) {
        this.requsetOption = {
            method: 'POST',
            headers: {
